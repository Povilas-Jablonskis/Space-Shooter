...
{
	application->getInputManager()->keyboardInput(c, x, y, application->getMenuManager(), application->getSoundEngine(), application->getLevelManager(), application->getGameStateManager(), application->getSpritesheetManager());
}
