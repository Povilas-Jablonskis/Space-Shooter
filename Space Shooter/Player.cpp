...
namespace Engine
{
	...
	{
		addObserver(ObserverEvent::HEALTHCHANGED, [](){ Application::instance()->updatePlayerHealth(); });
		addObserver(ObserverEvent::SCORECHANGED, [](){ Application::instance()->updatePlayerScore(); });
	}
